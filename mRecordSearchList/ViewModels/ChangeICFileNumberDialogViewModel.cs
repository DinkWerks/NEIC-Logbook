...
{
    public class ChangeICFileNumberDialogViewModel : BindableBase, IInteractionRequestAware, IRegionMemberLifetime
    {
        ...
        public INotification Notification
        {
            ...
            set { SetProperty(ref _notification, (IChangeICFileNumberNotification)value); }
        }
        ...
        {
            if (Prefix != null && !string.IsNullOrEmpty(Year) && Enumeration > 0)
                return true;
            else
                return false;
        }
